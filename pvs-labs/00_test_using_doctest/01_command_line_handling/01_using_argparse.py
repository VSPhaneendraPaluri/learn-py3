...
# Needs some FIX here !
parser.add_argument("--currencyType", help="Input the currency type - INR or USD")
parser.add_argument("--numberOfTwoThousands", help="Enter the number of Two Thousand rupee notes")
parser.add_argument("--numberOfFiveHundreds", help="Enter the number of Five Hundred rupee notes")
parser.add_argument("--numberOfTwoHundreds", help="Enter the number of Two Hundred rupee notes")
parser.add_argument("--numberOfOneHundreds", help="Enter the number of One Hundred rupee notes")
parser.add_argument("--numberOfFifties", help="Enter the number of Fifty rupee notes")
parser.add_argument("--numberOfTwenties", help="Enter the number of Twenty rupee notes")
parser.add_argument("--numberOfTens", help="Enter the number of Ten rupee notes")
